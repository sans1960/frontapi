...
const openModal = (op,name,mail,phone,department,employee) =>{
    clear();
        ...
        <div class="col-md-4 offset-md-4">
            <div class="d-grid col-10 mx-auto">
                ...
                data-bs-target="#modal" @click="openModal(1)">
                    <i class="fa-solid fa-circle-plus me-4"></i>Add
                </button>
            </div>
        </div>
    </div>
                    ...
                    <tr v-for="emp,i in employees.data" :key="emp.id">
                        ...
                        <td>
                            <button class="btn btn-warning" data-bs-toggle="modal"
                                ...
                                @click="openModal(2,emp.name,emp.mail,emp.phone,emp.department_id,emp.id)">
        ...
        <div class="modal-body">
            <form @submit.prevent="save">
                ...
                <div class="input-group mb-3">
                    ...
                    <input required type="email" v-model="form.mail" 
